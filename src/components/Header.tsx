...
export const Header: React.FC<HeaderProps> = ({ user, currentBranch, onBranchChange }) => {
  return (
    <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 fixed top-0 right-0 left-72 z-40 flex items-center justify-between px-8">
